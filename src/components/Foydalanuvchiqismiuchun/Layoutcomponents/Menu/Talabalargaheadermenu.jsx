...
const menuSections = [
  {
    ...
    links: [
      { label: "Yo‘riqnoma", to: "/" },
      { label: "Dars jadvali", to: "/" },
      { label: "Stipendiyalar", to: "/" },
      { label: "Iqtidorli talabalar", to: "/" },
    ],
  },
  {
    title: "Bakalavriat",
    links: [
      { label: "Kontingent", to: "/" },
      { label: "Davlat imtihonlari", to: "/" },
      { label: "Bitiruv malakaviy ish himoyasi", to: "/" },
      { label: "Odob ahloq qoidalari", to: "/" },
    ],
  },
];
    ...
    <div className="dark:text-gray-300">
      <ul className="flex items-center justify-center font-semibold lg:flex-row">
        ...
        <li className="relative group hidden lg:block px-3 py-2">
          ...
          <div
            ref={menuRef}
            className={`absolute top-full ${menuPosition} mt-3 bg-white dark:bg-gray-800 shadow-lg rounded-xl w-[560px] p-6 z-50
